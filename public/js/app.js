...
/***/ function(module, exports, __webpack_require__) {
	...
	Encrypted = __webpack_require__(13);

	Unencrypted = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Circle, DOTS, Line, Stats, dat, settings, win,
	  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

	Stats = __webpack_require__(2);

	dat = __webpack_require__(5);

	settings = __webpack_require__(3);

	win = __webpack_require__(8);
	...
	module.exports = DOTS = (function() {
	  ...
	  DOTS.prototype.update = function(time) {
	    ...
	    if (Math.floor(time) % settings.scaleTimer === 1) {
	      this.animateScale();
	    }
	  ...
	  DOTS.prototype.createGUI = function() {
	    var fallSpeed, gui, infinite, scaleTimer, sensitivity;
	    gui = new dat.GUI;
	    ...
	    infinite.onChange((function(_this) {
	      return function(change) {
	        ...
	        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
	          circle = _ref[_i];
	          _results.push(circle.infinite = change);
	        }
	        return _results;
	      };
	    })(this));
	    fallSpeed.onChange((function(_this) {
	      return function(change) {
	        var circle, speed, _i, _len, _ref, _results;
	        _ref = _this.circles;
	        _results = [];
	        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
	          circle = _ref[_i];
	          speed = Math.random() * change;
	          _results.push(circle.fallSpeed = speed);
	        }
	        return _results;
	      };
	    })(this));
	    scaleTimer.onChange((function(_this) {
	      return function(change) {
	        return _this.scaleTimer = Math.floor(change);
	      };
	    })(this));
	    return sensitivity.onChange((function(_this) {
	      return function(change) {
	        var circle, _i, _len, _ref, _results;
	        _ref = _this.circles;
	        _results = [];
	        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
	          circle = _ref[_i];
	          _results.push(circle.sensitivity = change);
	        }
	        return _results;
	      };
	    })(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = STATS = (function() {
	  ...
	  STATS.prototype.appendDomElement = function() {
	    return document.body.appendChild(this.stats.domElement);
	  };

	  STATS.prototype.setStyle = function() {
	    this.stats.domElement.style.position = 'absolute';
	    this.stats.domElement.style.left = '5px';
	    return this.stats.domElement.style.top = '5px';
	  };

	  STATS.prototype.setMode = function(mode) {
	    return this.stats.setMode(mode);
	  };

	  STATS.prototype.begin = function() {
	    var _ref;
	    return (_ref = this.stats) != null ? _ref.begin() : void 0;
	  };
	...
	module.exports = Circle = (function() {
	  ...
	  Circle.prototype.update = function() {
	    ...
	    if (settings.infinite) {
	      this.x = x + (mouse.x / settings.sensitivity) * this.radius;
	    } else {
...
/***/ function(module, exports) {
	...
	module.exports = ENCRYPTED = (function() {
	  ...
	  ENCRYPTED.prototype.makeCircle = function() {
	    var center, i, j, key, object, opacity, params, ring, _i, _ref, _results;
	    ...
	    this.group.translation.set(this.$el.width() / 2, this.$el.height() / 2);
	    i = 0;
	    ...
	    for (key in _ref) {
	      ...
	      _results.push(TweenMax.to(object, 5, params));
	    }
	    return _results;
	  };
	  ...
	  ENCRYPTED.prototype.importShape = function() {
	    ...
	    this.complexShape.opacity = 0.8;
	    return this.displaceVertices();
	  };

	  ENCRYPTED.prototype.displaceVertices = function() {
	    var child, key, object, params, x, y, _ref, _results;
	    _ref = this.complexShape.children;
	    _results = [];
	    for (key in _ref) {
	      child = _ref[key];
	      _results.push((function() {
	        ...
	        for (key in _ref1) {
	          ...
	          _results1.push(TweenMax.to(object, 5, params));
	        }
	        return _results1;
	      })());
	    }
	  ...
	  ENCRYPTED.prototype.update = function(frameCount, timeDelta) {
	    this.complexShape.rotation += 0.001;
	    return this.complexShape.scale = 0.02 * Math.sin(frameCount / 20) + 0.54;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Settings, Stats, UNENCRYPTED, dat, win,
	  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
	...
	module.exports = UNENCRYPTED = (function() {
	  UNENCRYPTED.prototype.scene = null;

	  UNENCRYPTED.prototype.width = 600;

	  UNENCRYPTED.prototype.height = 600;
	  ...
	  UNENCRYPTED.prototype.createGUI = function() {
	    var gui;
