...
/***/ function(module, exports, __webpack_require__) {
	...
	Encrypted = __webpack_require__(12);

	Unencrypted = __webpack_require__(13);
	...
	APP = (function() {
	  ...
	  APP.prototype.transitionIn = function() {
	    ...
	    if (this.encrypted) {
	      TweenMax.to(this.encrypted.el, 2, params);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Circle = __webpack_require__(9);

	Line = __webpack_require__(11);
	...
	module.exports = DOTS = (function() {
	  ...
	  DOTS.prototype.update = function(frameCount, timeDelta) {
	    ...
	    this.stats.begin();
	    if (frameCount % settings.scaleTimer === 1) {
	      this.animateScale();
	    }
	    _ref = this.circles;
	  ...
	  DOTS.prototype.createStats = function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = UNENCRYPTED = (function() {
	  ...
	  UNENCRYPTED.prototype.group = null;

	  UNENCRYPTED.prototype.ring = null;

	  UNENCRYPTED.prototype.params = {
	    type: 'SVGRenderer',
	    width: 600,
	    height: 600,
	    autostart: true
	  ...
	  UNENCRYPTED.prototype.evilDots = function() {
	    ...
	    for (i = _i = 0; _i < 200; i = ++_i) {
	      ...
	      _results.push(dot.translation.set(x, y));
	    }
	    return _results;
	  };
	  ...
	  UNENCRYPTED.prototype.createStats = function() {
	    this.stats = new Stats;
	    this.stats.setMode(2);
	    this.stats.domElement.style.position = 'absolute';
	    this.stats.domElement.style.left = '5px';
