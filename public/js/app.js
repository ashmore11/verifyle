...
/***/ function(module, exports, __webpack_require__) {
	...
	var Circle, DOTS, Line, dat, win,
	  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

	dat = __webpack_require__(2);
	...
	module.exports = DOTS = (function() {
	  ...
	  DOTS.prototype.infinite = false;

	  DOTS.prototype.fallSpeed = 0;

	  DOTS.prototype.scaleTimer = 10;
	  ...
	  DOTS.prototype.createGUI = function() {
	    var fallSpeed, gui, infinite, scaleTimer;
	    gui = new dat.GUI;
	    infinite = gui.add(this, 'infinite');
	    fallSpeed = gui.add(this, 'fallSpeed', 0, 10);
	    scaleTimer = gui.add(this, 'scaleTimer', 0, 50);
	    ...
	    return scaleTimer.onChange((function(_this) {
	      return function(change) {
	  ...
	  DOTS.prototype.update = function(frameCount, timeDelta) {
	    ...
	    if (frameCount % this.scaleTimer === 1) {
	      this.animateScale();
	    }
	    _ref = this.circles;
	    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
