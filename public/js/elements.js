...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = DOTS = (function() {
	  ...
	  DOTS.prototype.createLines = function() {
	    var line, origin, points;
	    origin = this.circles[0];
	    points = [this.circles[1], this.circles[2], this.circles[3]];
	    line = new Line(this.stage, origin, points);
	    origin = this.circles[12];
	    points = [this.circles[15], this.circles[26], this.circles[57]];
	    return line = new Line(this.stage, origin, points);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Circle, RAF, mouse, settings, win,
	  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
